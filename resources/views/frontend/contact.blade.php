...
<div class="full-row padding">
   <div class="container">
      <div class="row">
      <div class="col-lg-12">
                    <div class="contact-section-title">
                    <h3 class=" subtitle">WE'D LOVE TO</h3>
                     <h3 class="title">{{ __('HEAR FROM YOU') }}</h3>
                     <p class="">Send us a message and we' ll respond as soon as possible</p>
                    </div>
                </div>
