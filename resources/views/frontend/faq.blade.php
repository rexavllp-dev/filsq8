   ...
   <div class="container">
      <div class="row">
         <div class="col-lg-8 mx-auto">
            @foreach($faqs as $faq)
            <div class="simple-collaps bg-light px-4 py-3 border mb-3 p-0">
               <span class="accordion text-secondary d-block {{$loop->first ? 'active' : ''}}">
               <i class="fa fa-angle-right" aria-hidden="true"></i>{{ $faq->title }}</span>
