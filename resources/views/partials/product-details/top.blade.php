      ...
      <div class="col-12 col-lg-5 col-md-8">
        <div class="summary entry-summary">
          <div class="summary-inner">
            ...
            <h3 class="product_title entry-title">{{ $productt->affilateFrom->name }}</h3>

            <div class="pro-details">
              <div class="pro-info">
                <div class="woocommerce-product-rating">
                  <div class="fancy-star-rating">
                    <div class="rating-wrap"> <span class="fancy-rating good">{{
                        App\Models\Rating::ratings($productt->id) }} ★</span>
                    </div>
                    <div class="rating-counts-wrap">
                      <a href="#reviews" class="bigbazar-rating-review-link" rel="nofollow"> <span
                          class="rating-counts"> ({{ App\Models\Rating::ratingCount($productt->id) }}) </span> </a>
                    </div>
                  </div>
                </div>
                ...
                @else
                <div class="stock-availability in-stock text-bold">{{ $gs->show_stock == 0 ? '' : $productt->stock }} {{
                  ('In Stock') }}</div>
                @endif
                @endif
                ...
                <div class="product-offers">
                  <ul class="product-offers-list">
                    ...
                    <li class="product-offer-item"><span class="h6">{{ __('Estimated Shipping Time:') }}</span> {{
                      $productt->ship }}
                    </li>
                    @endif
                    ...
                    <li class="product-offer-item license-id"><span class="h6">{{ __('Platform:') }}</span> {{
                      $productt->platform }}
                    </li>
                    @endif
                    @if($productt->region != null)
                    <li class="product-offer-item license-id"><span class="h6">{{ __('Region:') }}</span> {{
                      $productt->region }}
                    </li>
                    @endif
                    @if($productt->licence_type != null)
                    <li class="product-offer-item license-id"><span class="h6"> {{ __('License Type:') }}</span> {{
                      $productt->licence_type }}
                    </li>
                    @endif
                    @endif
            ...
            <div class="report-area">
              <a class="report-item" href="javascript:;" data-bs-toggle="modal" data-bs-target="#report-modal"><i
                  class="fas fa-flag"></i> {{__('Report This Item')}}</a>
            </div>
            @else
            <div class="report-area">
              <a class="report-item" href="{{route('user.login')}}"><i class="fas fa-flag"></i> {{__('Report This
                Item')}} </a>
            </div>
            @endif
                    ...
                    <div class="">
                      ...
                      <div class="custom-control custom-radio form-check">
                        ...
                        <input type="radio" id="{{$attrKey}}{{ $optionKey }}" name="{{ $attrKey }}"
                          class="form-check-input custom-control-input product-attr" data-key="{{ $attrKey }}"
          ...
          <div class="price-summary">
            <div class="price-summary-content">
              ...
              <ul class="price-summary-list">
                ...
                <li class="selling-price"> <label>{{ $productt->whole_sell_qty[$key] }}+</label> <span><span
                      class="woocommerce-Price-amount amount">{{ $productt->whole_sell_discount[$key] }}% {{ __('Off')
                      }}
                    </span>
                  </span>
                </li>
                ...
                <div class="contact-form">
                  <form id="emailreply">
                    ...
                    <ul>
                      ...
                      <li>
                        <input type="email" class="form-control border mb-1" id="eml" name="email"
                          placeholder="{{ __('Email *') }}" required="">
                      </li>


                      <li>
                        <input type="text" class="form-control border mb-1" id="subj" name="subject"
              ...
              <div class="col-md-12">
                <div class="contact-form">
                  <form action="{{ route('user-send-message') }}" class="emailreply">
                    ...
                    <ul>
                      <li>
                        <input type="text" class="input-field" name="subject" placeholder="{{ __('Subject *') }}"
                          required="">
                      </li>
                      <li>
                        <textarea class="input-field textarea" name="message" placeholder="{{ __('Your Message') }}"
                          required=""></textarea>
                      </li>
