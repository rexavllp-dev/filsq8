...
@section('content')
    <div class="content-area">
        <div class="mr-breadcrumb">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="heading">{{ __('View Slider') }} <a class="add-btn" href="{{ route('admin-show-ads') }}"><i
                        ...
                        <div class="body-area">
                            ...
                            <form id="geniusform" action="{{ route('admin-sl-update', $data->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <select name="language_id" required="" disabled>
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="form-control" disabled name="subtitle_text" id="subtitle_text" rows="5"
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-4 d-none">
                                                        ...
                                                        <input class="form-control" disabled type="number"
                                                            name="subtitle_size" value="{{ $data->subtitle_size }}"
                                                            min="1">
                                                    </div>
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="form-control" disabled name="title_text" id="title_text" rows="5"
                                                    ...
                                                    <div class="col-sm-4 d-none">
                                                        ...
                                                        <select class="form-control" id="title_anime" name="title_anime">
                                                            ...
                                                            <option value="fadeInUp"
                                                                ...
                                                                fadeInUp</option>
                                                            <option value="flip"
                                                                {{ $data->title_anime == 'flip' ? 'selected' : '' }}>flip
                                                            </option>
                                                            <option value="flipInX"
                                    ...
                                    <div class="panel-body">
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                ...
                                                <textarea class="form-control" disabled name="details_text" id="details_text" rows="5"
                                                    placeholder="Enter Title Text">{{ $data->details_text }}</textarea>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-sm-4 d-none">
                                                        ...
                                                        <select class="form-control" id="details_anime"
                                                            ...
                                                            <option value="fadeInUp"
                                                                ...
                                                                fadeInUp</option>
                                                            <option value="flip"
                                                                {{ $data->details_anime == 'flip' ? 'selected' : '' }}>flip
                                                            </option>
                                                            <option value="flipInX"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-7">
                                        <input type="text" class="input-field" disabled name="link"
                                            placeholder="Link" required="" value="{{ $data->link }}">
