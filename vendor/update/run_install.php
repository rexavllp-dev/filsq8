<?php
define('FILSQ8','https://filsq8.com/verify/');
...
if (!isset($_POST['web_name']) || $_POST['web_name'] == ""){
  echo "Please Enter Website Name";
    ...
    $my_script =  'Filsq8 - Multi-vendor eCommerce CMS Platform';
    $my_domain = $_SERVER['HTTP_HOST'].str_replace('install/run_install.php','',$_SERVER['REQUEST_URI']);

    $varUrl = str_replace (' ', '%20', constant("FILSQ8").'purchase112662update.php?code='.$purchase_code.'&domain='.$my_domain.'&script='.$my_script);
