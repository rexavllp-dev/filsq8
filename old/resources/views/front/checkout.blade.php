												...
												<div class="row">
													<div class="col-lg-12">
														...
														<!-- 	@if($gs->is_paystack == 1)
															...
															@endif -->
															<!-- @if($gs->payle_checkout == 1)
															<a class="nav-link payment" data-val="" data-show="no" data-form="{{route('payle.submit')}}" data-href="{{ route('front.load.payment',['slug1' => 'payle','slug2' => 0]) }}" id="v-pills-tab9-tab" data-toggle="pill" href="#v-pills-tab9" role="tab" aria-controls="v-pills-tab9" aria-selected="false">
																	<div class="icon">
																			<span class="radio"></span>
																	</div>
																	<p>
