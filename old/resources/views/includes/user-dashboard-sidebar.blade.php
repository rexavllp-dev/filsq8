        <div class="col-lg-4">
          ...
          <div class="user-profile-info-area">
            <ul class="links">
             ...
             <!-- <li class="{{ $link == route('user-banner-index') ? 'active':'' }}">
                  <a href="{{route('user-banner-index')}}">Banner</a>
              </li>-->
