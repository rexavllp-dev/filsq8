...
@section('content')
                        ...
                        @include('includes.admin.form-both')
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="left-area">
															<h4 class="heading">{{ __('Amazon Link') }}</h4>
															<p class="sub-heading">Amazon affliate link</p>
														</div>
													</div>
													<div class="col-lg-12">
														<input type="text" class="input-field" placeholder="{{ __('Amazon affliate link') }}"
															name="affiliate_link"  value="{{ $data->affiliate_link }}" required="">
													</div>
												</div>
