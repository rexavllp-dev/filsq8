...
<?php $__env->startSection('content'); ?>
                        ...
                        <?php echo $__env->make('includes.admin.form-both', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
												...
												<div class="row">
													<div class="col-lg-12">
														<div class="left-area">
															<h4 class="heading"><?php echo e(__('Amazon Link')); ?></h4>
															<p class="sub-heading">Amazon affliate link</p>
														</div>
													</div>
													<div class="col-lg-12">
														<input type="text" class="input-field" placeholder="<?php echo e(__('Amazon affliate link')); ?>"
															name="affiliate_link"  value="<?php echo e($data->affiliate_link); ?>" required="">
													</div>
												</div>
