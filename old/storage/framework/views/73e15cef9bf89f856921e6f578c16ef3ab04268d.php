												...
												<h4 class="price"><?php echo e($prod->showPrice()); ?> <del><small><?php echo e($prod->showPreviousPrice()); ?></small></del></h4>
														...
														<div class="item-cart-area">
															...
															<?php else: ?>
																...
																<?php else: ?>
																<span class="add-to-cart-btn" data-href="<?php echo e(route('front.product', $prod->slug)); ?>">
																	<i class="icofont-eye"></i> details
																</span>
																<span class="add-to-cart-quick add-to-cart-btn"
																	data-href="<?php echo e(route('affiliate.product', $prod->slug)); ?>">
