        <div class="col-lg-4">
            ...
            <div class="row mt-4">
              <div class="col-lg-12 text-center">
                <a href="<?php echo e(route('user-package')); ?>" class="mybtn1 lg" style="    margin-bottom: 11px;">
                 ...
                 <a href="<?php echo e(route('user-banner_show')); ?>" class="mybtn1 lg">
                  <i class="fas fa-dollar-sign"></i> Show My advertisment 
                </a>
              </div>
            </div>
          <?php endif; ?>
          ...
          <div class="user-profile-info-area">
            <ul class="links">
             ...
             <!-- <li class="<?php echo e($link == route('user-banner-index') ? 'active':''); ?>">
                  <a href="<?php echo e(route('user-banner-index')); ?>">Banner</a>
              </li>-->
