											...
											<div class="info">
												...
												<h4 class="price">{{ $prod->showPrice() }} <del><small>{{ $prod->showPreviousPrice() }}</small></del></h4>
														...
														<div class="item-cart-area">
															<span onclick="window.location = '{{ route('front.product', $prod->slug) }}" class="add-to-cart-btn">
								...
								@else 
										...
										<a href="{{ route('front.product', $prod->slug) }}" class="item">
											...
											<div class="info">
												...
												<h4 class="price">{{ $prod->showPrice() }} <del><small>{{ $prod->showPreviousPrice() }}</small></del></h4>
														<h5 class="name">{{ $prod->showName() }}</h5>
														<div class="item-cart-area"><span onclick="window.location = '{{ route('front.product', $prod->slug) }}" class="add-to-cart-btn">
																	<i class="icofont-eye"></i> View Product
																</span></div>
											</div>
										</a>
