					...
					<div class="search-box-wrapper">
						<div class="search-box">
							...
							<form id="searchForm" class="search-form" action="{{ route('front.category', [Request::route('category'),Request::route('subcategory'),Request::route('childcategory')]) }}" method="GET">
								...
								@endif
								<input type="text" id="prod_name" required name="search" placeholder="{{ $langg->lang2 }}" value="{{ request()->input('search') }}" autocomplete="off">
				...
				<div class="col-lg-3 col-md-6 categorimenu-wrapper remove-padding">
					...
					<div class="categories_menu">
						<div class="categories_title">
							<h2 class="categori_toggle"><i class="fa fa-list"></i>  {{ $langg->lang14 }} </h2>
						</div>
						...
						<ul>
                                      ...
                                      <li>
                                        <a href="{{ App\Models\Socialsetting::find(1)->facebook }}" class="facebook" target="_blank">
                                            <img  style="margin-bottom: 4px; margin-left: 1px;"  src="{{ asset('assets/svg/FACEBOOK.svg') }}">
                                        </a>
                                      </li>
                                      @endif
                                      ...
                                      <li>
                                        <a href="{{ App\Models\Socialsetting::find(1)->gplus }}" class="google-plus" target="_blank">
                                            <img style="margin-bottom: 4px; margin-left: 1px;"   src="{{ asset('assets/svg/INSTAGRAM.svg') }}">
                                        </a>
                                      </li>
                                      @endif
                                      ...
                                      <li>
                                        <a href="{{ App\Models\Socialsetting::find(1)->twitter }}" class="twitter" target="_blank">
                                            <img style="margin-bottom: 4px; margin-left: 1px;"   src="{{ asset('assets/svg/TWITTER.svg') }}">
                                        </a>
                                      </li>
                                      @endif
                                      ...
                                      <li>
                                        <a href="{{ App\Models\Socialsetting::find(1)->linkedin }}" class="linkedin" target="_blank">
                                            <img style="margin-bottom: 4px; margin-left: 1px;"   src="{{ asset('assets/svg/SNAPCHAT.svg') }}">
                                        </a>
                                      </li>
                                      @endif
                                      ...
                                      <li>
                                        <a href="{{ App\Models\Socialsetting::find(1)->dribble }}" class="dribbble" target="_blank">
                                            <img style="margin-bottom: 4px; margin-left: 1px;"   src="{{ asset('assets/svg/TIKTOK.svg') }}">
                                        </a>
                                      </li>
                                      @endif
