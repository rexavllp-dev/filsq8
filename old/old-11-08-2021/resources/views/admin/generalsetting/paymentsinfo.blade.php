...
<hr>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                    <select class="process select droplinks {{ $gs->payle_checkout == 1 ? 'drop-success' : 'drop-danger' }}">
                                      <option data-val="1" value="{{route('admin-gs-payle',1)}}" {{ $gs->payle_checkout == 1 ? 'selected' : '' }}>{{ __('Activated') }}</option>
                                      <option data-val="0" value="{{route('admin-gs-payle',0)}}" {{ $gs->payle_checkout == 0 ? 'selected' : '' }}>{{ __('Deactivated') }}</option>
                                    </select>
                                  </div>
                            </div>
                          </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                <input type="text" class="input-field" placeholder="{{ __('Account ID') }}" name="payle_accountid" value="{{ $gs->payle_accountid }}" required="">
                               </div>
                            </div>
                          </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                <input type="text" class="input-field" placeholder="{{ __('Account Password') }}" name="payle_accountpassword" value="{{ $gs->payle_accountpassword }}" required="">
                               </div>
                            </div>
                          </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                <input type="text" class="input-field" placeholder="{{ __('Resource Key') }}" name="payle_resource_key" value="{{ $gs->payle_resource_key }}" required="">
                               </div>
                            </div>
                          </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                <input type="text" class="input-field" placeholder="{{ __('Business Code') }}" name="payle_business_code" value="{{ $gs->payle_business_code }}" required="">
                               </div>
                            </div>
                          </div>
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                <div class="action-list">
                                <textarea class="input-field" name="payle_text" placeholder="{{ __('Payle Text') }}" required>{{ $gs->payle_text }}</textarea>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-3">
                              <div class="left-area">
                                <h4 class="heading">
                                    {{ __('PayLe Sandbox Check ') }}
                                </h4>
                              </div>
                            </div>
                            <div class="col-lg-6">
                            <label class="switch">
                              <input type="checkbox" name="payle_mode" value="1" {{ $gs->payle_mode == 'sandbox' ? "checked":"" }}>
                              <span class="slider round"></span>
                            </label>
                           </div>
                          </div>
