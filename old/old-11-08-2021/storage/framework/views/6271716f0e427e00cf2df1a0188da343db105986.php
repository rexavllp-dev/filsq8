...
<?php $__env->startSection('content'); ?>
            ...
            <div class="content-area">
              <div class="mr-breadcrumb">
                <div class="row">
                  <div class="col-lg-12">
                      <h4 class="heading"><?php echo e(__('Add New Payment')); ?> <a class="add-btn" href="<?php echo e(url()->previous()); ?>"><i class="fas fa-arrow-left"></i> <?php echo e(__("Back")); ?></a></h4>
                      <ul class="links">
                        <li>
                        ...
                        <li>
                          <a href="<?php echo e(route('admin-payment-create')); ?>"><?php echo e(__('Add')); ?></a>
                        </li>
                      </ul>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-lg-12">
                    <div class="product-description">
                      ...
                      <form id="geniusform" action="<?php echo e(route('admin-payment-create')); ?>" method="POST" enctype="multipart/form-data">
