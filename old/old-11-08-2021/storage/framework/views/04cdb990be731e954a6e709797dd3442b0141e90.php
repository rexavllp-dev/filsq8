...
<?php $__env->startSection('content'); ?>
						...
						<div class="content-area">
							<div class="mr-breadcrumb">
								<div class="row">
									<div class="col-lg-12">
											<h4 class="heading"><?php echo e($langg->lang450); ?></h4>
											<ul class="links">
												<li>
													<a href="<?php echo e(route('vendor-dashboard')); ?>"><?php echo e($langg->lang441); ?> </a>
												</li>
												<li>
													<a href="<?php echo e(route('vendor-prod-import')); ?>"><?php echo e($langg->lang450); ?></a>
												</li>
											</ul>
									</div>
								</div>
                        ...
                        <?php echo $__env->make('includes.admin.form-both', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
											  ...
											  <div class="row">
												  <div class="col-lg-12 text-right">
													  <span style="margin-top:10px;"><a class="btn btn-primary" href="<?php echo e(asset('assets/product-csv-format.csv')); ?>"><?php echo e($langg->lang531); ?></a></span>
												  </div>
											  ...
											  <div class="row justify-content-center">
												  ...
												  <div class="col-lg-12 d-flex justify-content-center text-center">
													  <div class="left-area mr-4">
														  <h4 class="heading"><?php echo e($langg->lang532); ?> *</h4>
													  </div>
													  <span class="file-btn">
												...
												<div class="row">
													<div class="col-lg-12 mt-4 text-center">
														<button class="mybtn1 mr-5" type="submit"><?php echo e($langg->lang533); ?></button>
													</div>
												</div>
											</form>
									</div>
