                        ...
                        <li class="addtocart">
                          ...
                          <li class="addtocart">
                            <a href="javascript:;" class="cart-out-of-stock">
                              <i class="icofont-close-circled"></i>
                              <?php echo e($langg->lang78); ?> sdsd</a>
                            </li>
                            <?php else: ?>
    ...
    <div class="message-modal">
      ...
      <div class="modal" id="vendorform1" tabindex="-1" role="dialog" aria-labelledby="vendorformLabel1" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="vendorformLabel1">Contact Information</h5>
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
                      ...
                      <div class="seller-info mt-3">
                        <div class="content">
                          ...
                          <p class="stor-name">
                           ...
                           <br>
                           <a class="verify-link" href="javascript:;" data-toggle="tooltip" data-placement="top" title="" data-original-title="Verified">
                            <i class="fas fa-check-circle"></i>
                          </a>
                        </p>
                         <h4 class="title">
                         ...
                         <p class="stor-name">
                           <?php echo e($productt->user->shop_number); ?>
                          ...
                          <h4 class="title">
                           ...
                           <p class="stor-name">
                           <?php echo e($productt->user->shop_address); ?>
