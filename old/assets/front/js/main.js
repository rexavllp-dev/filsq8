...

{
  ...
  $(document).on('click', function(e) 
  {
    ...
    $('.themecolor li a').click(function(e){
        e.preventDefault();
        // alert('ok');
        $(this).parent().parent().find('a').removeClass('active');
        $(this).addClass('active');
        theme_color= $(this).data('color');
        $('#color').prop('href',mainurl+'/assets/front/css/styles.php?color='+theme_color+'&header_color='+header_color+'&footer_color='+footer_color+'&copyright_color='+copyright_color+'&menu_color='+menu_color+'&menu_hover_color='+menu_hover_color);
        $.get(mainurl+'/theme/'+theme_color);
    });

    $('.headercolor li a').click(function(e){
        e.preventDefault();
        $(this).parent().parent().find('a').removeClass('active');
        $(this).addClass('active');
        header_color = $(this).data('color');
        $('#color').prop('href',mainurl+'/assets/front/css/styles.php?color='+theme_color+'&header_color='+header_color+'&footer_color='+footer_color+'&copyright_color='+copyright_color+'&menu_color='+menu_color+'&menu_hover_color='+menu_hover_color);
        $.get(mainurl+'/header/'+header_color);
    });

    $('.catcolor li a').click(function(e){
        e.preventDefault();
        $(this).parent().parent().find('a').removeClass('active');
        $(this).addClass('active');
        menu_color = $(this).data('color');
        $('#color').prop('href',mainurl+'/assets/front/css/styles.php?color='+theme_color+'&header_color='+header_color+'&footer_color='+footer_color+'&copyright_color='+copyright_color+'&menu_color='+menu_color+'&menu_hover_color='+menu_hover_color);
        $.get(mainurl+'/menu/'+menu_color);
    });
