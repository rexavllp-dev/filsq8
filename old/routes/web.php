...
// Payment Informations
  ...
  Route::get('/general-settings/payle/{status}', 'Admin\GeneralSettingController@payle')->name('admin-gs-payle');
// Payment Gateways
...
Route::prefix('user')->group(function() {
  ...
  Route::get('/dashboard', 'User\UserController@index')->name('user-dashboard');
    Route::get('/banner', 'User\UserController@banner_upload')->name('user-banner-index');
    Route::post('/banner/creates', 'User\UserController@bannercreate')->name('user-banner-create');
...
// User Subscription
  ...
  Route::get('/package', 'User\UserController@package')->name('user-package');
    Route::get('/banner_show', 'User\UserController@banner_show')->name('user-banner_show');
      Route::get('/banner_uploads', 'Vendor\VendorController@banner_uploads')->name('vendor-banner-purchase');
  Route::get('/subscription/{id}', 'User\UserController@vendorrequest')->name('user-vendor-request');
     Route::post('/banner_update', 'Vendor\VendorController@banner_update')->name('vendor-banner-update');
  ...
  Route::post('/payle/submit', 'User\PayleController@store')->name('user.payle.submit');
  Route::post('/payle/notify', 'User\PayleController@notify')->name('user.payle.notify');
  Route::get('/payle/payreturn', 'User\PayleController@payreturn')->name('user.payle.return');
  Route::get('/payle/payreturntest', 'User\PayletestController@payreturn')->name('user.payle.testreturn');
  Route::get('/payle/paymentgateway', 'User\PayletestController@paymentgateway')->name('user.payle.paymentgateway');
...
// ************************************ FRONT SECTION **********************************************
  ...
  // PayLe
  Route::post('/payle-submit', 'Front\PayleController@store')->name('payle.submit');
  Route::get('/payle/notify', 'Front\PayleController@payreturn')->name('payle.notify');
