...
class ProductDetailsController extends FrontBaseController
{
    ...
    public function product(Request $request, $slug)
    {
        ...
        $productt = Product::with('affilateFrom')->where('slug', '=', $slug)->firstOrFail();
        ...
        if ($productt->other_affilates != null) {
            ...
            foreach ($other_affiliates as $key => $value) {
                $other_affiliates[$key]['affliate_from'] = $this->getAff($value);
            }
        ...
        // dd($productt);
        return view('frontend.product', compact('productt', 'curr', 'vendors', 'affilate_user', 'other_affiliates' ));

    }

    function getAff($value)
    {
        $other_affiliates_name = AffilateFrom::where('id', '=', $value['affliate_from'])->firstOrFail();
        $other_affiliates_name = $other_affiliates_name->logo;
        return $other_affiliates_name;
    }
