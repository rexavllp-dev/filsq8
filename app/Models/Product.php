...
class Product extends Model
{
    ...
    public function affilateFrom()
    {
        return $this->belongsTo('App\Models\AffilateFrom')->withDefault();
    }
